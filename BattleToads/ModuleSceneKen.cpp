...
ModuleSceneKen::ModuleSceneKen (bool start_enabled):
...
update_status ModuleSceneKen::Update ()
{
  ...
  App->renderer->Blit (graphics, 192, boatH + 103, &(girl.GetCurrentFrame ()),
		       0.75f);
