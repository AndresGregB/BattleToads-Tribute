...
void
ModuleControlEnemies::Clear ()
{
  App->textures->Unload (graphics);
}

void
ModuleControlEnemies::Update ()
{
  // Update Spawnpoints
  for (int i = 0; i < 6; i++)
    {
...
void
ModuleControlEnemies::PostUpdate ()
{

}

void
ModuleControlEnemies::Start ()
{
...
bool
ModuleControlEnemies::checkSpawningPoints ()
{
  for (int i = 0; i < 6; i++)
    {
...
void
ModuleControlEnemies::spawnEnemies (int spawningPoint)
{
  if (SDL_GetTicks () - spawns[spawningPoint].spawnTime >= 2000
      && spawns[spawningPoint].enemiesSpawned <
      spawns[spawningPoint].numEnemies)
    {
...
void
ModuleControlEnemies::enemyDefeated ()
{
  ++spawns[spawningPoint].enemiesDefeated;
}

void
ModuleControlEnemies::restoreSpawnpoints ()
{
  for (int i = 0; i < 6; i++)
    {
